					...
					<div class="col-md-8">
						<div class="title ">
							<div class="order-block">
								<p class="lh">Our consumer rentals and membership isn't open just yet. We'll let you know
									as soon as we're open so you can get your hands on the latest cutting-edge technology.</p>
							</div>
						</div> <!-- end title -->
					</div> <!-- end col-md-6 -->
